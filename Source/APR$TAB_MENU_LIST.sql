CREATE OR REPLACE package apr$tab_menu_list as 
  
  function render_tab_region(p_region               in apex_plugin.t_region
...
CREATE OR REPLACE package body apr$tab_menu_list 
as
  ...
  as
    ...
    is
      ...
      and    apex$checks.auth_condition_check_int(pat.condition_type
    ...
    is
      ...
      and    apex$checks.auth_condition_check_int(tab.condition_type
  ...
  begin
    ...
    into  r_temp;
    close c_temp;
    apex_debug.message('template opgehaald');
    /*Get the parent tabs*/
    ...
    for k in l_pat_table.first .. l_pat_table.last
    loop
      ...
      then
        ...
        */
        ...
        for h in l_tab_table.first .. l_tab_table.last
        loop
