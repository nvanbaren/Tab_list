...
''
 ,p_box => 
'<div id="header" class="ui-widget-header ui-corner-all ui-helper-clearfix">'||unistr('\000a')||
'  <table class="tbl-header" cellspacing="0" cellpadding="0" border="0" summary="">'||unistr('\000a')||
'    <tbody>'||unistr('\000a')||
'      <tr>'||unistr('\000a')||
'        <td class="tbl-header-cell logo">'||unistr('\000a')||
'          <a href="#HOME_LINK#">#LOGO##REGION_POSITION_06#</a>'||unistr('\000a')||
'        </td>'||unistr('\000a')||
'        <td class="tbl-header-cell plugin_name">'||unistr('\000a')||
'          &PLUGIN_FULL_NAME.'||unistr('\000a')||
'        </td>'||unistr('\000a')||
'       '||
' <td class="tbl-header-cell nav"> '||unistr('\000a')||
...
'<div id="messages">#SUCCESS_MESSAGE#'||
'#NOTIFICATION_MESSAGE##GLOBAL_NOTIFICATION#</div>'||unistr('\000a')||
...
'</div>'
 ,p_footer_template => 
'<div id="footer" class="ui-widget-header ui-corner-all'||unistr('\000a')||
'"><div class="content">'||unistr('\000a')||
'<div id="customize">#CUSTOMIZE#</div>'||unistr('\000a')||
'<div class="app-version">&COPYRIGHT.</div>'||unistr('\000a')||
...
'</div>'
 ,p_navigation_bar => '<span class="navbar">#BAR_BODY#</span>'
 ,p_navbar_entry => '<span class="navbar-entry #IMAGE#"><a href="#LINK#" class="t1NavigationBar">#TEXT#</a></span>'
